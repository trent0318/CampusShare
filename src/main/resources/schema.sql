-- =====================================================================
-- CampusShare 建表脚本（供 Spring Boot sql.init 或手动执行）
-- 注意：Phase 1 已关闭 Spring 自动执行（application.yml 中 sql.init.mode=never），
--       请优先使用项目根目录的 CampusShare.sql 完成建库建表。
--       本文件与 data.sql 为同一套结构的拆分版，便于后续 Phase 8 打包。
-- =====================================================================
